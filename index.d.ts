 ...
 */
export declare const sendCommerce: (commerceTemplate: CommerceTemplateType, callback?: CallbackType) => Promise<SendResultType>;
/**
 * sendList
 ...
 * @returns {Promise<SendResultType>}
 */
export declare const sendList: (listTemplate: ListTemplateType, callback?: CallbackType) => Promise<SendResultType>;
/**
 * sendFeed
 ...
 * @returns {Promise<SendResultType>}
 */
export declare const sendFeed: (feedTemplate: FeedTemplateType, callback?: CallbackType) => Promise<SendResultType>;
/**
 * sendText
 ...
 * @returns {Promise<SendResultType>}
 */
export declare const sendText: (textTemplate: TextTemplateType, callback?: CallbackType) => Promise<SendResultType>;
/**
 * sendLocation
 ...
 * @returns {Promise<SendResultType>}
 */
export declare const sendLocation: (locationTemplate: LocationTemplateType, callback?: CallbackType) => Promise<SendResultType>;
/**
 * sendCustom
